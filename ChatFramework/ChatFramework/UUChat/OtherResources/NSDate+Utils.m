...
#define DATE_COMPONENTS (NSCalendarUnitYear| NSCalendarUnitMonth | NSCalendarUnitDay | NSCalendarUnitWeekOfMonth |  NSCalendarUnitHour | NSCalendarUnitMinute | NSSecondCalendarUnit | NSCalendarUnitWeekday | NSCalendarUnitWeekOfYear)
...
- (NSString *)weekday
{
    ...
    comps =[calendar components:(NSCalendarUnitWeekOfMonth | NSCalendarUnitWeekday |NSCalendarUnitWeekOfYear)
                       fromDate:date];
